...
The data has 506 observations of 14 variables. These variables describe per capita crime rate by town, average number of rooms per dwelling and pupil-teacher ratio by town. The chas variable is 1 a boolean variable, where the value is 1 if tract bounds the Charles river and 0 otherwise)
